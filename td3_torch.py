...
class Agent:
    ...
    def __init__(self, actor_learning_rate, critic_learning_rate, input_dims, tau, env, gamma=0.99, update_actor_interval=2,
        ...
        self.critic_1 = CriticNetwork(input_dims=input_dims, n_actions=n_actions, fc1_dims=layer1_size,
                                     fc2_dims=layer2_size, name="critic_1", learning_rate=critic_learning_rate)

        self.critic_2 = CriticNetwork(input_dims=input_dims, n_actions=n_actions, fc1_dims=layer1_size,
                                     fc2_dims=layer2_size, name="critic_2", learning_rate=critic_learning_rate)
        ...
        self.target_critic_1 = CriticNetwork(input_dims=input_dims, n_actions=n_actions, fc1_dims=layer1_size,
                                     fc2_dims=layer2_size, name="target_critic_1", learning_rate=critic_learning_rate)

        self.target_critic_2 = CriticNetwork(input_dims=input_dims, n_actions=n_actions, fc1_dims=layer1_size,
                                     fc2_dims=layer2_size, name="target_critic_2", learning_rate=critic_learning_rate)
